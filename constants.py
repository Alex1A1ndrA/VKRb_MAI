...
SECRETARY_DEFAULT = "ассистент кафедры 806 Плотникова Н.О." # секретарь по умолчанию
DASH = "---" # заглушка для пустых полей

GRADE_MAP = {'5': 'отлично', '4': 'хорошо', '3': 'удовлетворительно'} # Соответствие числовой оценки текстовой
...
template_path_pred_bachelor = os.path.join(BASE_PATH_TEMPLATES, 'Предзащиты.docx')
template_path_pred_master   = os.path.join(BASE_PATH_TEMPLATES, 'ПредзащитыМаг.docx')
